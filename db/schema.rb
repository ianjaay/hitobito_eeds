...
ActiveRecord::Schema[8.0].define(version: 2026_05_10_184700) do
  ...
  create_table "additional_emails", id: :serial, force: :cascade do |t|
    ...
    t.virtual "search_column", type: :tsvector, as: "to_tsvector('french'::regconfig, ((COALESCE((email)::text, ''::text) || ' '::text) || regexp_replace(COALESCE((email)::text, ''::text), '[@_+-]'::text, ' '::text, 'g'::text)))", stored: true
  ...
  create_table "addresses", force: :cascade do |t|
    ...
    t.text "numbers"
    t.virtual "search_column", type: :tsvector, as: "to_tsvector('french'::regconfig, ((((((COALESCE((street_short)::text, ''::text) || ' '::text) || COALESCE((town)::text, ''::text)) || ' '::text) || COALESCE((zip_code)::text, ''::text)) || ' '::text) || COALESCE(numbers, ''::text)))", stored: true
  ...
  create_table "crises", id: :serial, force: :cascade do |t|
  ...
  create_table "event_approvals", id: :serial, force: :cascade do |t|
  ...
  create_table "event_participations", id: :serial, force: :cascade do |t|
    ...
    t.datetime "j_s_data_sharing_accepted_at", precision: nil
  ...
  create_table "event_translations", force: :cascade do |t|
    ...
    t.virtual "search_column", type: :tsvector, as: "to_tsvector('french'::regconfig, COALESCE((name)::text, ''::text))", stored: true
  ...
  create_table "events", id: :serial, force: :cascade do |t|
    ...
    t.virtual "search_column", type: :tsvector, as: "to_tsvector('french'::regconfig, COALESCE((number)::text, ''::text))", stored: true
  ...
  create_table "groups", id: :serial, force: :cascade do |t|
    ...
    t.string "hostname"
    t.virtual "search_column", type: :tsvector, as: "to_tsvector('french'::regconfig, ((((((((((((((((((((((((COALESCE((name)::text, ''::text) || ' '::text) || COALESCE((short_name)::text, ''::text)) || ' '::text) || COALESCE((email)::text, ''::text)) || ' '::text) || regexp_replace(COALESCE((email)::text, ''::text), '[@_+-]'::text, ' '::text, 'g'::text)) || ' '::text) || COALESCE((street)::text, ''::text)) || ' '::text) || COALESCE((housenumber)::text, ''::text)) || ' '::text) || COALESCE((zip_code)::text, ''::text)) || ' '::text) || COALESCE((town)::text, ''::text)) || ' '::text) || COALESCE((country)::text, ''::text)) || ' '::text) || COALESCE((pbs_shortname)::text, ''::text)) || ' '::text) || COALESCE(description, ''::text)) || ' '::text) || COALESCE((website)::text, ''::text)) || ' '::text) || COALESCE((bank_account)::text, ''::text)))", stored: true
    t.index ["hostname"], name: "index_groups_on_hostname", unique: true
  ...
  create_table "groups_filters", force: :cascade do |t|
    ...
    t.date "active_at", default: -> { "now()" }, null: false
  ...
  create_table "invoice_item_translations", force: :cascade do |t|
    ...
    t.index ["search_column"], name: "invoice_item_translations_search_column_gin_idx", using: :gin
  end
  ...
  create_table "invoice_items", id: :serial, force: :cascade do |t|
    ...
    t.virtual "search_column", type: :tsvector, as: "to_tsvector('french'::regconfig, ((COALESCE((account)::text, ''::text) || ' '::text) || COALESCE((cost_center)::text, ''::text)))", stored: true
  ...
  create_table "invoices", id: :serial, force: :cascade do |t|
    ...
    t.virtual "search_column", type: :tsvector, as: "to_tsvector('french'::regconfig, ((((COALESCE((title)::text, ''::text) || ' '::text) || COALESCE((reference)::text, ''::text)) || ' '::text) || COALESCE((sequence_number)::text, ''::text)))", stored: true
  ...
  create_table "kantonalverband_cantons", id: :serial, force: :cascade do |t|
  ...
  create_table "member_counts", id: :serial, force: :cascade do |t|
    t.integer "kantonalverband_id", null: false
    t.integer "region_id"
  ...
  create_table "people", id: :serial, force: :cascade do |t|
    ...
    t.boolean "has_family_in_scouting", default: false, null: false
    ...
    t.index ["matricule_scout"], name: "index_people_on_matricule_scout", unique: true, where: "(matricule_scout IS NOT NULL)"
  ...
  create_table "roles", id: :serial, force: :cascade do |t|
    ...
    t.date "start_on"
    t.date "end_on"
    t.datetime "alumni_invitation_processed_at", precision: nil
    t.datetime "alumni_reminder_processed_at", precision: nil
